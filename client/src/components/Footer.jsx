			...
			<div className="flex gap-1">
				<Link to="https://facebook.com" target="_blank">
					<span className="hover:text-blue-600">
						<FacebookLogo size={32} weight="bold" className="hover:scale-105 transition-all duration-500" />
					</span>
				</Link>

				<Link to="https://x.com/gps_96169" target="_blank">
					<span className="hover:text-blue-400">
						<TwitterLogo size={32} weight="bold"  className="hover:scale-105 transition-all duration-500"/>
					</span>
				</Link>

				<Link to="https://www.linkedin.com/in/gyan-pratap-singh-275785236/" target="_blank">
					<span className="hover:text-blue-700">
						<LinkedinLogo size={32} weight="bold" className="hover:scale-105 transition-all duration-500" />
					</span>
				</Link>

				<Link to="https://github.com/Gyanthakur" target="_blank">
					<span className="hover:text-gray-800">
						<GithubLogo size={32} weight="bold" className="hover:scale-105 transition-all duration-500" />
					</span>
				</Link>
				...
				<Link to="https://wa.me/918957818597?text=Hey%20%F0%9F%91%8B%2C%20how%20can%20I%20help%20you%3F" target="_blank">
					<span className="hover:text-green-500">
						<WhatsappLogo size={32} weight="bold" className="hover:scale-105 transition-all duration-500" />
					</span>
				</Link>
			</div>
		</div>
